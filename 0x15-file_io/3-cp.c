...
/**
 * create_buffer - ALlocates 1024byte for a buffer.
 * @file: The name of the file buffer is storing char for.
 * Return: a pointer to the newly allocated  biffer.
 */
char *create_buffer(char *file)
{
	char *buffer;
 ...
 * @fd: The file descriptor to be closedd.
 */
void close_file(int fd)
{
	int c;
 ...
 * Desc: If the file count is incorrect - exit code 97
